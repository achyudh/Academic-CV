...
\begin{innerlist}
    \item Worked with the \href{http://www.swag.uwaterloo.ca/}{Software Architecture Group} and the \href{https://chil.uwaterloo.ca/}{Computational Health Informatics Lab} on the \href{https://cs.uwaterloo.ca/~jhoey/research/themis.cog/index.php}{THEMIS.COG} project
\end{innerlist}
...
\begin{innerlist}
    \item Worked with the \href{http://swerl.tudelft.nl/bin/view/Main/WebHome}{Software Engineering Research Group (SERG)} on developing a pull request reviewability evaluation framework
...
\begin{innerlist}
    \item[] \emph{In Proceedings of MaLTeSQuE 2018 (Workshop on Machine Learning Techniques for Software Quality Evaluation) collocated with SANER 2018}
\end{innerlist}
