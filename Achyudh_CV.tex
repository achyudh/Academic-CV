...
\item[] \textbf{B.E. (Hons.), Computer Science}, \emph{Expected:} August 2018
        ...
        \item Advisor: \href{https://sback.it/}{Prof. Alberto Bacchelli}, TU Delft
        \end{innerlist}
...
\textbf{Teaching Assistant} - Neural Networks \& Fuzzy Logic \hfill {Jan 2017 -- May 2017}
\begin{innerlist}
...
\textbf{Teaching Assistant} - Data Structures \& Algorithms \hfill {Jan 2017 -- May 2017}
\begin{innerlist}
...
\textbf{Student Researcher, \href{http://swerl.tudelft.nl/bin/view/Main/WebHome}{SERG, TU Delft}} \hfill {Aug 2017 -- Dec 2017}
\begin{innerlist}
...
\textbf{Software Developer Intern, Intuit Inc.} \hfill {May 2017 -- Jul 2017}
\begin{innerlist}
...
\textbf{Economic Research \& Planning Intern, Indian Bank HQ} \hfill {May 2015 -- Jul 2015}
\begin{innerlist}
...
\textbf{Analysis framework for decoding online developer communities} \hfill {Dec 2015 -- 
May 2017}
Advisor: \href{https://prasadtalasila.wordpress.com/}{Prasad Talasila} \hfill Code: \href{https://github.com/achyudhk/Mailing-List-Network-Analyzer}{github.com/achyudhk/Mailing-List-Network-Analyzer}
\vspace{0.5mm}
\begin{innerlist}
...
\begin{innerlist}
\item Monte-Carlo methods to assess the feasibility of biofuel production using simulation of economic models (Advisor: \href{http://universe.bits-pilani.ac.in/goa/rajorshis/profile}{Dr. Rajorshi Sen Gupta}) \hfill Nov 2015
\item Cross country analysis of statistical models for assessing the effect of economic factors on insurance penetration (Advisor: \href{http://universe.bits-pilani.ac.in/goa/aswini/profile}{Dr. Aswini Kumar Mishra}) \hfill May 2016
\item Rationality, uncertainty and cognition in financial markets – An experimental approach using double auction asset market simulation (Advisor: \href{http://universe.bits-pilani.ac.in/goa/anoopk/profile}{Dr. Anoop Kumar}) \hfill May 2017
\end{innerlist}
