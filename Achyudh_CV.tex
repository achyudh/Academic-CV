...
\textbf{\scshape Phase 1:} \emph{Assessing the reviewability of code changes and automating the evaluation of GitHub Pull Requests} \hfill \emph{Aug '17 -- Dec '17}
    \begin{innerlist}
        \item Adviser: \href{https://sback.it/}{Prof. Alberto Bacchelli}, Delft University of Technology 
        \item Identification of factors associated with the reviewability of code changes using a comprehensive literature review, statistical modelling, developer surveys and task-guided interviews
        \item Building an automated pull request evaluation framework based on these factors, and validate its usefulness in an industrial setting.
    \end{innerlist}
...
\begin{innerlist}
    \item Working with Dr. Mei Nagappan on the \href{https://cs.uwaterloo.ca/~jhoey/research/themis.cog/index.php}{Theoretical and Empirical Modeling of Identity and Sentiments in Collaborative Groups (THEMIS.COG)} project
\end{innerlist}
...
\begin{innerlist}
    \item Worked with the \href{http://swerl.tudelft.nl/bin/view/Main/WebHome}{Software Engineering Research Group (SERG)} on my senior thesis
    \item Participated in courses on mining software repositories and software engineering methods
\end{innerlist}

\halfblankline

\textbf{Economic Research Intern, Indian Bank HQ} \hfill \emph{May '15 -- Jul '15}
\begin{innerlist}
...
\begin{innerlist}
    \item Developed a data engine for layout-based retrieval from the database
    \item Built a reports engine that uses this data engine to provide performance insights for businesses
    \item Approx. 400\% faster compared to existing solutions due to parallel query evaluation 
...
\vspace{0.5mm} \\
An analysis of author interaction through community detection in mailing lists and IRC channels
using a text mining based approach to identify topic experts and label communities, in order to examine the activity and decode the structure of the developer communities.
...
\begin{innerlist}
    \item[]  Machine Learning, Neural Networks \& Fuzzy Logic, Information Retrieval, Mining Software Repositories, Software Engineering Methods, Parallel Computing, Compiler Design, Computer Networks, Design \& Analysis of Algorithms, Data Structures \& Algorithms, Discrete Structures in Computer Science, Operating Systems, Computer Architecture, Principles of Programming Languages, Theory of Computation, Database Systems, Object Oriented Programming, Logic in Computer Science, Microprocessor Programming \& Interfacing, Computer Programming, Digital Design
\end{innerlist}
...
\textbf{Mathematics}
\begin{innerlist}
    \item[] Multivariable Calculus, Linear Algebra, Differential Equations, Probability \& Statistics, Advanced Econometrics, Mathematical \& Statistical Methods
\end{innerlist}
...
\textbf{Languages}
\begin{innerlist}
    \item[] C, C++, Python, Java, C\#, JavaScript, R, BASH, SQL, MongoDB, Verilog HDL, HTML, CSS, MIPS32 \& x86 Assembly
\end{innerlist}
...
\begin{innerlist}
    \item[] Amazon Web Services, Google Cloud Platform, Firebase, Android Dev, Docker, \LaTeX, NumPy, SciPy, Scikit-Learn, Matplotlib, NLTK, Gensim, Keras, NetworkX, iGraph, Graph-Tool, Flask, Pandas, Scikit-Image, LEX, YACC
\end{innerlist}
