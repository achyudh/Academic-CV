...
\textbf{Frameworks}
\begin{innerlist}
    \item[] Amazon Web Services, Google Cloud Platform, Firebase, Android Dev, Docker, \LaTeX, NumPy, SciPy, Scikit-Learn, Matplotlib, NLTK, Gensim, Keras, NetworkX, Chart.js, iGraph, Graph-Tool, Flask, Pandas, Scikit-Image, LEX, YACC
\end{innerlist}
